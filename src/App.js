...
import { Admin, Resource, CustomRoutes, useCreate, Switch } from "react-admin";
...
function App() {
  return (
    <BrowserRouter basename="/ebs">
      <Admin
        authProvider={authProvider}
        loginPage={CustomLoginPage}
        dataProvider={restProvider(privateConfig.development.REACT_APP_API_URL)}
